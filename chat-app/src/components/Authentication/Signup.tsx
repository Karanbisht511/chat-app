            ...
            <div className="login-wrapper" >
                <div className="login-box">
                    ...
                    <div className="inputs">
                        ...
                        <div className="round-corners input-wrapper" >
                            <span>&#x2709;</span><input type="email" name="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email" />
                        </div>
                        <div className="round-corners input-wrapper" >
                            <span>&#x260E; </span><input type="mobile" name="mobile" value={mobile} onChange={e => setMobile(e.target.value)} placeholder="Phone no" />
                        </div>
                    </div>
                    <div className="button-signin">
                        <button className="round-corners" onClick={LoginUser}>Create Account</button>
                    </div>
                </div>
            </div>
